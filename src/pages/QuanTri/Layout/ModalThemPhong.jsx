...
import { addPhong } from "../../../redux/Reducers/QuanTri/QuanLyPhongThunk";

const ModalThemPhong = () => {
  ...
  const handleSubmit = async () => {
    try {
      await dispatch(addPhong(formData));
      setOpenModal(false);
    } catch (error) {
      console.error("Failed to add phong: ", error);
    }
  };
