    ...
    <footer id="footer">
      ...
      >
        <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
          <h3 className="pt-12 text-center text-white font-bold text-3xl uppercase">
            Luôn được cập nhật
          </h3>
          ...
          <div className="relative w-full md:w-1/2 mx-auto">
            ...
            <input
              type="email"
              id="default-email"
              className="block w-full p-4 ps-10 text-sm border rounded-t-lg bg-cyan-950/90 border-cyan-700 placeholder-cyan-400 text-white focus:ring-cyan-500 focus:border-cyan-500"
              placeholder="Địa chỉ email của bạn..."
              required
            />
            <button
              type="submit"
              className="text-white absolute end-2.5 bottom-2.5 focus:ring-1 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 bg-cyan-600 hover:bg-cyan-700 focus:ring-cyan-500"
            >
              Đăng ký tin
            </button>
          </div>
          ...
          <div className="w-full md:w-1/2 mx-auto bg-cyan-950/60 border-cyan-700 border rounded-b-lg">
            <p className="pt-4 text-center text-white">
              Chuyến đi mơ ước nằm trong tầm tay bạn. Tải xuống ứng dụng.
            </p>
